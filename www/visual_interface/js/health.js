 ...
 *    (раньше форсировал полный обход всех устройств в петле HA — отсюда старый запрет на поллинг).
 *    Поллить теперь можно, но подписка всё равно предпочтительнее: свежесть без таймера и меньше
 *    задержка на срочном событии (см. ниже).
 ...
 *    как раз и задерживал (до 300 с) — подписка видит его сразу.
 *
